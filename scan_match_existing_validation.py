...
def get_user_and_dependent_id_from_ticketsto(match_doc_id):
    ...
    if match_doc.exists:
        ...
        if ticket_status == "Activated":
            ...
            if team1 == "Brighton" and team2 == "Chelsea":
                ...
                if ticketsto:
                    ...
                    return user_id, dep_ids, match_ref
                else:
                    print("TicketsTo field is empty.")
                    return None, [], None
            else:
                print("Invalid match for scanning.")
                return None, [], None
        else:
            print("Ticket is not activated.")
            return None, None, None
    else:
        print("Match document not found in Firestore.")
        return None, [], None
...
while True:
    ...
    user_id, dep_ids, match_ref = get_user_and_dependent_id_from_ticketsto(match_doc_id)
